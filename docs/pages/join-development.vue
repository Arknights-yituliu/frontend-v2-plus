...
<template>
  ...
  <img src="/image/doc/git-terminal.jpg" alt="">
  <p>
    输入上述命令后按确认，会出现如下打印内容，由于仓库的提交历史过大，需要下载一会，也可以通过追加命名参数选择不下载历史提交记录</p>
  <img src="/image/doc/download-repository.jpg" alt="">
...
<!--  </v-sheet>-->
  <img src="/image/doc/install-package.jpg" alt="">
