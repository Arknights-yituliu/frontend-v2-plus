...
<template>
  ...
  <h2 id="edit-page">编辑内容</h2>
  <v-divider></v-divider>
  <p>如果你想更新页面，直接在对应的页面内修改即可，文档页面目录路径为 <v-code>/docs/pages</v-code></p>
  <h2 id="create-page">新建页面</h2>
  <v-divider></v-divider>
  <p>如果你想新增一个页面，以下为举例：</p>
  <h3 id="create-page-1">1.在目录 <v-code>/docs/pages</v-code> 下新建一个 <v-code>writing-documentation.vue</v-code> 组件</h3>
  ...
  <p>我们可以在标签内写一个测试文本 <v-code>&lt;h2>hello world&lt;/h2></v-code></p>
...
&lt;/style&gt;</v-code></pre>
  ...
  <v-divider></v-divider>
  <p>此时我们的组件还无法通过导航和链接访问，我们需要添加路由，添加路由的文件在 <v-code>docs/router/routes.js</v-code> 文件内</p>
