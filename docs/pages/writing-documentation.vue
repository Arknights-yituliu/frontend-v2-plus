...
<template>
  ...
  <v-alert  border variant="tonal" type="info"  >
    ...
    <LinkButton text="Vue" link="https://cn.vuejs.org/guide/introduction"></LinkButton>、<LinkButton text="JavaScript" link="https://www.runoob.com/js/js-intro.html"></LinkButton>、<LinkButton text="HTML" link="https://www.runoob.com/html/html-tutorial.html"></LinkButton>
  </v-alert>

  <h2 id="edit-page">编辑内容</h2>
  <v-divider></v-divider>
  <p>如果你想更新页面，直接在对应的页面内修改即可，文档页面目录路径为/docs/pages</p>
  <h2 id="create-page">新建页面</h2>
  <v-divider></v-divider>
  <p>如果你想新增一个页面，以下为举例：</p>
  <h3 id="create-page-1">1.在目录/docs/pages下新建一个 writing-documentation.vue组件</h3>
