      ...
      <a class="href_black" href="https://jq.qq.com/?_wv=1027&k=ZmORnr5F">
        <div class="mdui-card dev-card">
          ...
          <div class="dev-card-text">
            ...
            <div class="dev-card-text-content">讨论开发事宜</div>
          </div>
        </div>
      </a>
    </div>
    ...
    <div class="mdui-typo" id="dev_feedback">
      ...
      <a class="href_black" href="https://space.bilibili.com/688411531">
        <div class="mdui-card dev-card">
          ...
          <div class="dev-card-text">
            ...
            <div class="dev-card-text-content">Bilibili信息发布</div>
          </div>
        </div>
      </a>
      <a class="href_black" href="https://jq.qq.com/?_wv=1027&k=q1z3p9Yj">
        <div class="mdui-card dev-card">
          ...
          <div class="dev-card-text">
            ...
            <div class="dev-card-text-content">信息发布 实用Bot</div>
          </div>
        </div>
      </a>
      ...
      <a class="href_black" href="https://docs.qq.com/form/page/DVVNyd2J5RmV2UndQ">
        <div class="mdui-card dev-card">
          <img class="dev-card-icon" src="/image/website/qq.webp" alt="" />
          <div class="dev-card-text">
            <div class="dev-card-text-title">在线收集表</div>
            <div class="dev-card-text-content">填写表单，记录问题</div>
          </div>
        </div>
      </a>
    ...
    <div class="mdui-typo" id="dev_team">
      ...
      <a class="href_black" href="https://github.com/yamasakura">
        <div class="mdui-card dev-card dev-card-member">
          ...
          <div class="dev-card-text">
            ...
            <div class="dev-card-text-content">后端 前端</div>
          </div>
        </div>
      </a>
      <a class="href_black" href="https://space.bilibili.com/10057492">
        <div class="mdui-card dev-card dev-card-member">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">Zirunwang</div>
            <div class="dev-card-text-content" style="font-style: italic">创建者</div>
            <div class="dev-card-text-content">算法 UI 前端</div>
          </div>
        </div>
      </a>
      <a class="href_black" href="https://github.com/hguandl">
        <div class="mdui-card dev-card dev-card-member">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">hguandl</div>
            <div class="dev-card-text-content" style="font-style: italic">创建者</div>
            <div class="dev-card-text-content">后端</div>
          </div>
        </div>
      </a>
      ...
      <a class="href_black" href="https://github.com/hguandl">
        <div class="mdui-card dev-card dev-card-member">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">一个资深的烧饼</div>
            <div class="dev-card-text-content" style="font-style: italic">开发</div>
            <div class="dev-card-text-content">算法</div>
          </div>
        </div>
      </a>
      <a class="href_black" href="https://github.com/lethefrost">
        <div class="mdui-card dev-card dev-card-member">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">寒上词</div>
            <div class="dev-card-text-content" style="font-style: italic">开发</div>
            <div class="dev-card-text-content">UI</div>
          </div>
        </div>
      </a>
      ...
      <a class="href_black" href="https://github.com/Yanstory">
        <div class="mdui-card dev-card dev-card-member">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">Yanstime</div>
            <div class="dev-card-text-content" style="font-style: italic">开发</div>
            <div class="dev-card-text-content">前端</div>
          </div>
        </div>
      ...
      <a class="href_black" href="https://space.bilibili.com/12786648">
        <div class="mdui-card dev-card dev-card-member">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">無冕Crownless</div>
            <div class="dev-card-text-content" style="font-style: italic">开发</div>
            <div class="dev-card-text-content">UI</div>
          </div>
        </div>
      ...
      <a class="href_black" href="https://github.com/youcai922">
        <div class="mdui-card dev-card dev-card-member">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">youcai922</div>
            <div class="dev-card-text-content" style="font-style: italic">开发</div>
            <div class="dev-card-text-content">后端</div>
          </div>
        </div>
      ...
      <a class="href_black" href="https://github.com/Ks-luow">
        <div class="mdui-card dev-card dev-card-member">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">Ks-luow</div>
            <div class="dev-card-text-content" style="font-style: italic">开发</div>
            <div class="dev-card-text-content">后端</div>
          </div>
        </div>
      ...
      <a class="href_black" href="https://github.com/ZFengMo/ZFengMo">
        <div class="mdui-card dev-card dev-card-member">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">ZFengMo</div>
            <div class="dev-card-text-content" style="font-style: italic">开发</div>
            <div class="dev-card-text-content">前端</div>
          </div>
        </div>
    ...
    <div class="mdui-typo" id="dev_refer">
      ...
      <a class="href_black" href="https://ak.hypergryph.com/">
        <div class="mdui-card dev-card dev-card-member-ref">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">明日方舟</div>
            <div class="dev-card-text-content" style="font-style: italic">明日方舟官方网站</div>
            <div class="dev-card-text-content">图片素材</div>
          </div>
        </div>
      </a>
      <a class="href_black" href="https://penguin-stats.cn">
        <div class="mdui-card dev-card dev-card-member-ref">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">企鹅物流数据统计</div>
            <div class="dev-card-text-content" style="font-style: italic">素材掉率统计网站</div>
            <div class="dev-card-text-content">关卡掉率数据</div>
          </div>
        </div>
      </a>
      <a class="href_black" href="https://github.com/yuanyan3060/ArknightsGameResource">
        <div class="mdui-card dev-card dev-card-member-ref">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">Arknights-Bot-Resource</div>
            <div class="dev-card-text-content" style="font-style: italic">明日方舟常用素材</div>
            <div class="dev-card-text-content">图片素材</div>
          </div>
        </div>
      </a>
      <a class="href_black" href="https://prts.wiki/w/%E9%A6%96%E9%A1%B5">
        <div class="mdui-card dev-card dev-card-member-ref">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">prts.wiki</div>
            <div class="dev-card-text-content" style="font-style: italic">明日方舟wiki</div>
            <div class="dev-card-text-content">图片素材 关卡数据</div>
          </div>
        </div>
      </a>
      <a class="href_black" href="https://space.bilibili.com/8412516">
        <div class="mdui-card dev-card dev-card-member-ref">
          ...
          <div class="dev-card-text">
            <div class="dev-card-text-title">罗德岛蜜饼工坊</div>
            <div class="dev-card-text-content" style="font-style: italic">明日方舟饼学研究组</div>
            <div class="dev-card-text-content">活动排期数据</div>
          </div>
        </div>
      </a>
    </div>
