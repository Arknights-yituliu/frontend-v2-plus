...
<template>
  <div class="weekly">
    ...
    <section class="banner">
      <!-- <img src="banner.jpg" alt="活动海报" /> -->
      <div class="event-info">
        <h2>SideStory 出击白海</h2>
        <p>12/18 28:00</p>
      </div>
    </section>
    <section class="content">
      ...
      <div class="material-tips">
        <h3>掉落物品提示</h3>
        <p>说明不同章节的掉落物及概率</p>
      </div>
      <div class="data-section">
        <h3>数据区</h3>
        <p>预计更新版本：2025 ZE春节限定</p>
        <div class="operators">
          <!-- <img src="op1.jpg" alt="干员1">
                <img src="op2.jpg" alt="干员2">
                <img src="op3.jpg" alt="干员3">
                <img src="op4.jpg" alt="干员4"> -->
        </div>
      </div>
  ...
  <div id="stage" class="stage-page">
    ...
    <div id="stageForCards" class="stage-card-wrap" style="background-color: rgb(45,45,45);max-width: 420px;">
      <div class="stage-card" v-for="(stage, index) in stageCardData" :key="index"
        @click="getItemTableData(index, true)" :id="`c-${index}`" style="background-color: rgb(61,61,61);margin: 4px;">
    ...
    <!-- 详情表 -->
    <div id="detail-table"
      style="margin:0px 8px;width: 900px;height: 495px;border: 1px solid #00000040;font-size: 18px;padding: 15px 22px;">
