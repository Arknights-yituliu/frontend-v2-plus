...
export default {
  ...
  data() {
    return {
      ...
      startTime: "", //开始时间
      endTime: "2023/08/15 04:00:00", //结束时间
      start_TimeStamp: "", //开始时间戳
      end_TimeStamp: "", //结束时间戳
      timeSelector: "夏活(8.15)", //活动时间节点选择框的绑定对象
  ...
  methods: {
    ...
    compute() {
      ...
      //当月月卡是否已经购买
      this.calResults.originium_gacha -= this.monthlyFlag * 6;

      //额外月卡购买数量
      this.calResults.originium_gacha += this.monthlyCardExtra * 6;
      // 计算额外月卡的价格
      this.sellsCount += this.monthlyCardExtra * 30;
