    ...
    <div class="stageDetail_main">
      ...
      <div class="stageTable">
        <div  v-for="(stage,key) in stageTable[zondId]" >
            <button @click="findStageDetailByStageCode(stage.stageId,stage.stageCode);stageCode=stage.stageCode" class="stageId" >{{ stage.stageCode }}</button>
        </div>
      </div>
      <div class="zoneTable">
...
const zoneNameList = ref(["第十二章 (标准)","第十一章 (标准)","第十章 (标准)",
"第九章","第八章","第七章",
"第六章","第五章","第四章",
"第三章","第二章","第一章","序章",
"生于黑夜・复刻",
