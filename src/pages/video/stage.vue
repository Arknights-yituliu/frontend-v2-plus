...
let hiddenSSStageFlag = ref(false)
  ...
  <div id="stage" class="stage-page">
    ...
    <div class="module-header">
      ...
      <div style="display: flex;flex-wrap: wrap;align-items: center;margin-top: 20px;">
        ...
        <v-switch hide-details v-model="hiddenSSStageFlag" @change="hiddenSSStage()"
                  color="primary" class="m-0-8"
                  label="隐藏活动关卡">
          <template v-slot:append>
            <v-tooltip
...
<!--    </v-alert>-->
    ...
    <div id="stageForCards" class="stage-card-wrap">
      <div class="stage-card" v-for="(stage, index) in stageCardData" :key="index"
        ...
        <div class="stage-card-bar-container">
          ...
          <div class="stage-card-bar">
            <ItemImage :item-id="'AP_GAMEPLAY'" size="40" mobile-size="30"></ItemImage>
          ...
          <!-- 第二行 -->
          <div class="stage-card-bar">
            <ItemImage :item-id="stage.series.T4" size="40" mobile-size="30"></ItemImage>
            <div class="stage-card-bar-stage-code">
          ...
          <!-- 第三行 -->
          <div class="stage-card-bar">
            <ItemImage :item-id="stage.series.T3" size="40" mobile-size="30"></ItemImage>
            <div class="stage-card-bar-stage-code">
          ...
          <div class="stage-card-bar" v-show="stage.series.T2">
            <ItemImage :item-id="stage.series.T2" size="40" mobile-size="30"></ItemImage>
            <div class="stage-card-bar-stage-code">
      ...
      <!-- 网站信息卡 -->
      <div class="stage-card" style="align-items: center; flex-grow: 0;">
        <div style="display: inline-block;margin:0px 16px ;">
          明日方舟一图流<br>
          ark.yituliu.cn<br>
          2024/12/20
        </div>
        <img src="/image/website/QR/yituliuQR.png" style="height: 150px; display: inline-block;">
      </div>
...
<style>
  ...
  .stage-card-bg-sprite{
    left: -72px !important;
    top: -9px !important;
  }

  .stage-card-bar-container{
