...
//控制筛选栏的展开
function barCollapse(className,elementId) {
  const wrapHeight = document.getElementById(elementId).offsetHeight;
  ...
  if (wrapHeight<1) {
    ...
    setTimeout(() => {
      document.getElementById(elementId).style.height = 0 + "px";
    }, 100);
  }
}
...
export { characterListInit, getProfession, professionDict, yearDict, scoreListInit, rankingListinit,barCollapse };
