<template>
  <div class="score_page">
    ...
    <div class="survey_control_wrap" id="switch_filter_wrap">
      ...
      <div class="control-line filter" id="score_selector_dimension">
      ...
      <div class="control-line filter" id="score_selector_class">
      ...
      <div class="control-line filter" id="score_selector_rarity">
      ...
      <div class="control-line filter" id="score_selector_years">
      ...
      <div class="control-line filter" id="score_selector_sort">
