...
const CONTROL_CENTER_RULE_IDS = Object.freeze([
  "w-island-meeting",
  "w-island-control",
  "silverash-karlan",
  "gnosis-karlan",
...
const CROSS_FACILITY_RULE_IDS = Object.freeze([
  "rushu-gummy",
  "justice-wildmane",
  "friston-kaltsit",
  "phonor-logos",
  "secret-team-firefox",
  "faith-mixer-fiammetta",
  "saint-snow-silverash",
]);

const ROOM_COMBINATION_RULE_IDS = Object.freeze([
  "bellone-sileach",
  "deep-scout-ulpian",
]);
...
const ASSESSMENT_SYSTEMS = Object.freeze([
  {
    ...
    ruleIds: CONTROL_CENTER_RULE_IDS,
    category: "控制中枢",
    title: "控制中枢体系",
    summary:
      "查看核心干员进驻控制中枢后，对贸易站、制造站和会客室产生的联动效果。",
    facilities: ["control", "trading", "manufacture", "meeting", "hire"],
    coreOperators: [
      "维什戴尔",
      "凛御银灰",
      "八幡海铃",
    ...
    skillRooms: ["control", "trading", "manufacture", "meeting", "power"],
    relatedOperators: [
      ...getTermMembers(
        ["karlan", "siracusa", "blacksteel", "knight", "glasgow", "redpine"],
        ["薇薇安娜", "焰尾", "正义骑士号", "灵知"],
      ),
      "伊内丝",
      "赫德雷",
  ...
  },
  {
    id: "cross-facility",
    ruleSourceId: "control-cross-room",
    ruleIds: CROSS_FACILITY_RULE_IDS,
    category: "跨设施",
    title: "跨设施体系",
    summary:
      "查看核心干员与辅助干员分驻不同设施时产生的制造、发电、会客室和办公室联动。",
    facilities: [
      "control",
      "trading",
      "manufacture",
    ...
    engineStatus: "P15 公式目录待接入",
    engineNote:
      "只展示明确跨设施的成员、位置和体系效果，不把缺少的状态资源当作已满足。",
  },
  {
    id: "room-combination",
    ruleSourceId: "control-cross-room",
    ruleIds: ROOM_COMBINATION_RULE_IDS,
    category: "站内组合",
    title: "站内组合",
    summary:
      "单独查看需要在同一贸易站内完成的干员组合，避免与跨设施规则混在一起。",
    facilities: ["trading"],
    coreOperators: ["贝洛内", "深巡"],
    participantOperators: ["伺夜", "乌尔比安"],
    skillRooms: ["trading"],
    relatedOperators: ["伺夜", "乌尔比安"],
    engineStatus: "P15 公式目录待接入",
    engineNote:
      "这里的规则只要求同一贸易站或基建内条件，不属于跨设施联动。",
  },
  {
    id: "elite-facilities",
    category: "全局计数",
