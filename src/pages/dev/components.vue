...
const colors = ['blue', 'orange', 'green', 'red', 'purple', 'cyan']

let buttonLightStyle = ''
let buttonDarkStyle = ''
let buttonColorsMap = []
for (const color of colors) {
  ...
  buttonColorsMap +=
      `
      '${color}': (
                background: var(--c-button-${color}-background),
...
console.log('按钮亮色样式')
console.log(buttonLightStyle)
console.log('按钮暗色样式')
console.log(buttonDarkStyle)
console.log('按钮颜色变量')
