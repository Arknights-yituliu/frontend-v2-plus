...
const navi_data = [
  { title: "刷图推荐1", desc: "我该去哪刷图？活动图效率怎么样？xx图适合不适合搓玉？xx材料什么时候up过？", icon: "/image/icon/无框_全新装置.png", link: "/" },
...
<template>
  ...
  <div class="theme_light">
    <div class="light_card demo_card">
      ...
      <div class="demo_button">这里是一个按钮</div>
...
export const documentProps = {
  title: "一图流 - 排班生成器",
  description: "明日方舟一图流，排班生成器，基建排班",
};
</script>
