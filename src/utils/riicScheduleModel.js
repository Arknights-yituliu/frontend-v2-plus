...
// Compatibility helper for callers that only need the number of occupants.
export function getRiicRoomStationSlots(options) {
  return getRiicRoomStations(options).map((currentStation) =>
    currentStation ? currentStation.slotCount : null,
  );
}
